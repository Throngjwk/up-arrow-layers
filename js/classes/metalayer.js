    ...
    constructor()
    {
        ...
        this.multiplierUpgrades = [
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Multiplier",
                ...
                level => new Decimal(1),
                level => Decimal.pow(10, level.pow(game.restackLayer.upgradeTreeNames.resourceMultipliersLevelScaling.apply())).pow(this.getResourceMultiplierBoost()))
        ];
        ...
        this.powerUpgrades = [
            new MetaDynamicLayerUpgrade("Increase the Resource Power",
                ...
                level => new Decimal(1),
                level => Decimal.pow(1.35, level).pow(this.getResourcePowererBoost()).mul(game.restackLayer.upgradeTreeNames.resourcePowerersStrength.apply()), {
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Power",
                ...
                level => new Decimal(1),
                level => Decimal.pow(1.25, level).pow(this.getResourcePowererBoost()).mul(game.restackLayer.upgradeTreeNames.resourcePowerersStrength.apply()), {
                    getEffectDisplay: effectDisplayTemplates.numberStandard(2, "^")
                }),
            new MetaDynamicLayerUpgrade("Increase the Resource Power",
            ...
            new MetaDynamicLayerUpgrade("Increase the Resource Power",
                ...
                level => new Decimal(1),
                level => Decimal.pow(1.096, level).pow(this.getResourcePowererBoost()).mul(game.restackLayer.upgradeTreeNames.resourcePowerersStrength.apply()), {
                    getEffectDisplay: effectDisplayTemplates.numberStandard(2, "^")
                })
        ];
    }
